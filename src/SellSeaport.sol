...
contract SellSeaport {
    ...
    constructor(
        ...
        WETH = IWETH(_WETH);
        // Setup Seaport exchange contract (0x59728544B08AB483533076417FbBB2fD0B17CE3a)
        SEAPORT = ISeaport(_SEAPORT);
        // Give Seaport exchange approval to execuate sell (0xf42aa99F011A1fA7CDA90E5E98b277E306BcA83e)
